...
if(error) return <ErrorComponent message={"Error while fetching Coins"}/>
  ...
  <RadioGroup value={currency} onChange={setCurrency} p={"8"}>
   ...
   <Text fontSize={"small"} alignItems={"center"}  opacity={0.7} w="100%" display={"inline-block"}>
   ...
   <Badge fontSize={"1.5xl"} bgColor={"black"} color={"white"}>
   ...
   low={`${currencySymbol} ${coin.market_data.low_24h[currency]}`}/>
     ...
     <Box>
      ...
      <Item title={"Circulating_Supply"} value={coin.market_data.circulating_supply}/>
